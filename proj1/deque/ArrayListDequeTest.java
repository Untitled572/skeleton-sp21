...
public class ArrayListDequeTest {
    ...
    public void addRemoveLastTest() {
        ...
        assertTrue("lld2 should be empty upon initalization", lld2.isEmpty());

        lld2.addLast(10);
        assertFalse("lld2 should contain 1 item", lld2.isEmpty());

        lld2.removeLast();
        assertTrue("lld2 should be empty after removal", lld2.isEmpty());
    }
    ...
    public void randomMethodTest() {
        ...
        lld1.addLast(10);
        lld1.addFirst(15);
        assertEquals(10, (long) lld1.removeLast());
        //lld1.printDeque();
        assertEquals(5, (long) lld1.removeLast());
        assertEquals(15, (long) lld1.removeLast());
        assertNull(lld1.removeLast());
